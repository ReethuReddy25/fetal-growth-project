...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (goResults) goResults.addEventListener("click", () => window.location.href = "/results");  // ✅ FIXED

  const goUpload = document.getElementById("goUpload");
  if (goUpload) goUpload.addEventListener("click", () => window.location.href = "/upload");  // ✅ FIXED

  const goLogin = document.getElementById("goLogin");
  if (goLogin) goLogin.addEventListener("click", () => window.location.href = "/login");  // ✅ FIXED
